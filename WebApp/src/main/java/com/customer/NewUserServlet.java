...
import com.customer.MemberDBUtill;
...
public class NewUserServlet extends HttpServlet {
	...
	private Member MemberDBUtill;

	//initialising the memberDao as a object
	public void init(){
		MemberDBUtill = new Member();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MemberDBUtill Nmember = new MemberDBUtill();
		boolean istrue;
		//sending the member object to addMember method in memberDao class
		try {
			istrue = Nmember.addMember(member);
