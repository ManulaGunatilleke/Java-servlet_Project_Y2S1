<%@page import="com.home.Products"%>
<%@page import="com.home.ProductCatalog"%>
<%@ page language="java" import="java.net.*,java.text.*" %>
...
// Create the URL for adding the item to the shopping cart.
        String addItemURL = "AddToShoppingCartServlet?"+"productCode="+URLEncoder.encode(item.getProduct_id())+"&description="+URLEncoder.encode(item.getDescription())+"&quantity=1"+"&price="+URLEncoder.encode(""+item.getShow_price());
%>
